    ...
    <div class="content_container">
        <div class="d-flex">
            ...
            <transition name="fade" mode="out-in">
                <router-link v-if="specialities.length > 0" :to="'/speciality/' + specialities[0].id" class="main-button red-hover a-btn">View as items</router-link>
            </transition>
        </div>
        ...
        methods:{
            deleteItem(grade){
                this.$props.modals.delete = {
                    visible: true,
                    url: `/api/speciality/${grade.grade_id}/delete`,
                    method: 'POST',
